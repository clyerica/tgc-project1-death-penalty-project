...
document.querySelector('#mail-list-btn').addEventListener('click', function(){
    ...
    if(!form.firstName=='' && !form.lastName=='' && form.email.includes('@','.')){
        document.querySelector('#mail-form').innerHTML="<h3 class='text-center'>Thanks for joining us!</h3>"
    }
    else{
        if (form.firstName==''){
